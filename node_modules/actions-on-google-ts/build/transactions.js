...
var Order = function () {
  ...
  _createClass(Order, [{
    ...
    key: 'addOtherItems',
    value: function addOtherItems(items) {
      if (!items) {
    ...
    value: function setTermsOfService(url) {
      if (!url) {
    ...
    key: 'setTotalPrice',
    value: function setTotalPrice(priceType, currencyCode, units, nanos) {
      if (!priceType) {
...
var Cart = function () {
  ...
  _createClass(Cart, [{
    key: 'setMerchant',
    value: function setMerchant(id, name) {
      if (!id) {
    ...
    key: 'addLineItems',
    value: function addLineItems(items) {
      if (!items) {
        error('items cannot be null');
        return this;
      }
...
var LineItem = function () {
   ...
   */
  function LineItem(lineItemId, name) {
  ...
  _createClass(LineItem, [{
    key: 'addSublines',
    value: function addSublines(items) {
      if (!items) {
        error('items cannot be null');
        return this;
      }
    ...
    key: 'setPrice',
    value: function setPrice(priceType, currencyCode, units, nanos) {
      if (!priceType) {
        error('priceType cannot be empty');
        return this;
      }
    ...
    key: 'setOfferId',
    value: function setOfferId(offerId) {
      if (!offerId) {
...
var OrderUpdate = function () {
   ...
   */
  function OrderUpdate(orderId, isGoogleOrderId) {
  ...
  _createClass(OrderUpdate, [{
    key: 'setGoogleOrderId',
    value: function setGoogleOrderId(orderId) {
      if (!orderId) {
    ...
    key: 'setActionOrderId',
    value: function setActionOrderId(orderId) {
      if (!orderId) {
        error('orderId cannot be empty');
        return this;
      }
    ...
    key: 'setOrderState',
    value: function setOrderState(state, label) {
      if (!state) {
      ...
      this.orderState = { state: state, label: label };
      return this;
    }
    ...
    key: 'setUpdateTime',
    value: function setUpdateTime(seconds, nanos) {
      if (!seconds || seconds < 0) {
        error('Invalid seconds');
        return this;
      }
      this.updateTime = { seconds: seconds, nanos: nanos || 0 };
      return this;
    }
    ...
    key: 'setUserNotification',
    value: function setUserNotification(title, text) {
      if (!title) {
      ...
      this.userNotification = { title: title, text: text };
      return this;
    }
    ...
    key: 'addOrderManagementAction',
    value: function addOrderManagementAction(type, label, url) {
      if (!type) {
        error('type cannot be empty');
        return this;
      }
    ...
    key: 'addLineItemPriceUpdate',
    value: function addLineItemPriceUpdate(itemId, priceType, currencyCode, units, nanos, reason) {
      if (!itemId) {
    ...
    key: 'addLineItemStateUpdate',
    value: function addLineItemStateUpdate(itemId, state, label, reason) {
      if (!itemId) {
        error('itemId cannot be empty');
        return this;
      }
      ...
      this.lineItemUpdates[itemId].orderState = { state: state, label: label };
      this.lineItemUpdates[itemId].reason = reason || this.lineItemUpdates[itemId].reason;
    ...
    value: function setInfo(type, data) {
      ...
      try {
        for (var _iterator5 = Object.keys(TransactionValues.OrderStateInfo)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var infoType = _step5.value;
