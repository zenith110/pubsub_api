...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Pubsub.image":
		...
		return e.complexity.Pubsub.Image(childComplexity), true

	case "Pubsub.name":
		if e.complexity.Pubsub.Name == nil {
			break
		}

		return e.complexity.Pubsub.Name(childComplexity), true

	case "Pubsub.onsale":
		if e.complexity.Pubsub.Onsale == nil {
			break
		}
...
func (ec *executionContext) _Pubsub_image(ctx context.Context, field graphql.CollectedField, obj *model.Pubsub) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Pubsub_onsale(ctx context.Context, field graphql.CollectedField, obj *model.Pubsub) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Pubsub(ctx context.Context, sel ast.SelectionSet, obj *model.Pubsub) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, pubsubImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Pubsub")
		case "name":
			out.Values[i] = ec._Pubsub_name(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "image":
			out.Values[i] = ec._Pubsub_image(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "saledates":
...
var pubsubsImplementors = []string{"Pubsubs"}

func (ec *executionContext) _Pubsubs(ctx context.Context, sel ast.SelectionSet, obj *model.Pubsubs) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, pubsubsImplementors)
